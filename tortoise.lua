...
stepheight = 1,
	...
	view_range = 4,
	replace_rate = 10,
	replace_what = {"farming:carrot_7", "farming:carrot_8", "farming_plus:carrot", "farming:tomato", "farming:lettuce", "farming:cucumber", "farming:cabbage", "livingdesert:date_palm_fruits", "livingdesert:figcactus_fruit"},
	replace_with = "air",
